  ...
  const fullScreen = useMediaQuery(theme.breakpoints.down('md'));
    ...
    const fetchDataOnMount = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:5000/get_user_payments?category=${selectedCategory}&page=${currentPage}`,
          {
    ...
    const fetchUsers = async (page) => {
      try {
        ...
        const authToken = localStorage.getItem("access_token");        
        const response = await axios.get(
          `http://localhost:5000/get_user_payments?category=${selectedCategory}&page=${page}`,
          {
            headers: {Authorization: `Bearer ${authToken}`,},
          }
        );
...
return(
		<div className="col-xl-6">
          ...
          <div className="row users-table-top">
	            <div className="col-xl-6">
                <h4 className="card-title mb-4">Your Payment History</h4>
              </div>             
