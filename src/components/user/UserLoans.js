  ...
  const fullScreen = useMediaQuery(theme.breakpoints.down('md'));
    ...
    const fetchUsers = async (page) => {
      try {
        ...
        const authToken = localStorage.getItem("access_token");        
        const response = await axios.get(
          `http://localhost:5000/get_user_loans?category=${selectedCategory}&page=${page}`,
          {
            headers: {Authorization: `Bearer ${authToken}`,},
          }
        );
...
return(
		<div className="col-xl-6">
          ...
          <div className="row users-table-top">
                ...
                <h4 className="card-title mb-4">Your Loan History</h4>
              </div>             
              ...
              <div className="col-xl-4 search-users-select-cat-container">
                <Stack direction="row" className="add-user-container">
                  <NavLink to="request-loan" className="add-user-link">
